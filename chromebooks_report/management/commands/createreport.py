...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options) -> None:
        ...
        self.stdout.write(
            self.style.SUCCESS(f"[{timestamp}] Report created successfully.")
        )
    ...
    def get_chromebooks_activity(self) -> list:
        ...
        for ticket in tickets_in_view:
            ...
            site_ticket["assignee"] = self.zendesk_api.get_user(ticket['assignee_id'])['user']['name'] if ticket['assignee_id'] else 'NONE'
